...
function Hero() {
  return (
    ...
    */}
      {/* Card 1 */}
      <div className="h-[26.5rem] w-[20rem]  bg-transparent cursor-pointer group prespective rounded-2xl ">
        <div className="relative preserve-3d group-hover:my-rotate-y-180 w-full h-full duration-1000">
          <div className="absolute  w-full h-full backface-hiiden rounded-xl ">
            <img
      ...
      <div className="h-[26.5rem] w-72  bg-transparent cursor-pointer group prespective rounded-2xl ">
        <div className="relative preserve-3d group-hover:my-rotate-y-180 w-full h-full duration-1000">
          ...
          <div className="absolute w-full h-[26.5rem] bg-red-500 my-rotate-y-180 backface-hiiden  rounded-2xl">
            <div className="block    w-72 rounded-xl bg-[#111] shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] ">
              <div
                className="relative overflow-hidden bg-cover bg-no-repeat rounbded-t-xl"
                //data-te-ripple-init
