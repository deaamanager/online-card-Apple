...
function Main() {
  ...
  <div className="absolute  w-[90%]  h-full top-[12.5rem] md:top-[14rem] lg:top-[12.1rem] xl:top-[19.3rem] md:w-[45%]  mb-24.  bg-gradient-to-t from-black via-black/50 z-20  rounded-2xl opacity-95 imageEffect bottom-0 " />
